  ...
  try {
    ...
    for (const pl of postLikes) {
      ...
      notifications.push({
        ...
        linkUrl: `/dashboard?postId=${pl.post.id}`,
        read: false,
    ...
    for (const pc of postComments) {
      ...
      notifications.push({
        ...
        linkUrl: `/dashboard?postId=${pc.post.id}&commentId=${pc.id}`,
        read: false,
    ...
    for (const cl of commentLikes) {
      ...
      notifications.push({
        ...
        linkUrl: `/dashboard?postId=${cl.comment.postId}&commentId=${cl.comment.id}`,
        read: false,
    ...
    for (const cr of commentReplies) {
      ...
      notifications.push({
        ...
        linkUrl: `/dashboard?postId=${cr.parent.postId}&commentId=${cr.id}`,
        read: false,
    ...
    for (const mp of mentionedPosts) {
      ...
      notifications.push({
        ...
        linkUrl: `/dashboard?postId=${mp.id}`,
        read: false,
