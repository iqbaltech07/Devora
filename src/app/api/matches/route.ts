  ...
  try {
    ...
    rawMatches.forEach((m, index) => {
      ...
      partnerMap.set(partner.id, {
        ...
        experienceYears: partner.experienceYears !== null && partner.experienceYears !== undefined ? Number(partner.experienceYears) : undefined,
        experienceLevel: (partner.experienceLevel as any) || undefined,
        workPreference: (partner.workPreference as any) || undefined,
        flexibleHours: partner.flexibleHours ?? true,
        availableDays: partner.availableDays || [],
        portfolioUrl: partner.portfolioUrl || undefined,
